...
{/*
    public partial class PrintCv_bak : System.Web.UI.Page
    {
        ...
        {
            get { return printDefContext.Current; }
        }
        ...
        protected IEnumerable<Project> GetRemainingProjects()
        {
            ...
            {
                if (p.CustomerId != this.PrintDef.CustomerId) yield return p;
            }
        }
        ...
        protected List<Project> GetCustomerProjects()
        {
            if (this.customerProjects==null)
            {
                ...
                foreach (Project p in MyResource.Projects)
                {
                    if (p.CustomerId == PrintDef.CustomerId) customerProjects.Add(p);
                }
            }
