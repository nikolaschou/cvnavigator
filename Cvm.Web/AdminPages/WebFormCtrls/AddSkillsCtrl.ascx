<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="AddSkillsCtrl.ascx.cs" Inherits="Cvm.Web.AdminPages.WebFormCtrls.AddSkillsCtrl" %>
    <asp:Panel ID="NewSkillPanel" Visible="false" runat="server">
        <div class="dialog" id="addSkillDiv" title='<%= Utl.Content("ProjectSkillsCtrl2.AddNewSkillTitle")%>'>
            ...
            <asp:ListBox runat="server" Rows="10" ID="SkillListBox" Height="200" Width="400" SelectionMode="Multiple" /><br />
            </div>
            <div id="btnDiv"><ad:AdmButton ID="AdmButton2" runat="server" CausesValidation="false" OnClientClick="javascript:submitSkillForm()" ContentId="ProjectSkillsCtrl2.AddSelSkills2"  /></div><br /><br />
            ...
            <ad:AdmLinkButton ID="AdmButton1" CssClass="stdLink" runat="server" ContentId="ProjectSkillsCtrl2.AddNewSkill" CausesValidation="false" OnClick="OnClickAddNewSkillBtn"/>
            </span>
        </div>
        <span id="selectedSkillIds" style="display:none">
        <asp:TextBox ID="SelectedSkillIdsBx" runat="server" OnTextChanged="OnClickAddSelSkillsBtn" AutoPostBack="true" CausesValidation="true"/>
